...
# for population encoder, positive samples are the same activity, different people
# negative samples are the same person, different activity
# for personalized encoder, vice versa
