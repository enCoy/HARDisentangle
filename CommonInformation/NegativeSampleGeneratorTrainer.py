...
if __name__ == "__main__":
    ...
    train_X, train_y, test_X, test_y = data_processor.generate_autoregressive_negative_samples(data_processor.data_dict,
    ...
    # save state dict
    torch.save(model.state_dict(), os.path.join(save_dir, f"negativeGeneratorStateDict.pth"))
    # save model
    torch.save(model, os.path.join(save_dir, f"negativeGenerator.pth"))
