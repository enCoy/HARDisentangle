...
class cnn(nn.Module):
    def __init__(self):
        ...
        self.layer1 = nn.Sequential(
            ...
            nn.BatchNorm2d(128),
            nn.ReLU(True),
            nn.Conv2d(in_channels=128, out_channels=128, kernel_size=(6, 1), stride=(2, 1), padding=0),
            nn.BatchNorm2d(128),
            nn.ReLU(True)
        )
        ...
        self.layer2 = nn.Sequential(
            nn.Conv2d(in_channels=128, out_channels=256, kernel_size=(6, 1), stride=(2, 1), padding=0),
            nn.BatchNorm2d(256),
            nn.ReLU(True),
            nn.Conv2d(in_channels=256, out_channels=256, kernel_size=(6, 1), stride=(2, 1), padding=0),
            nn.BatchNorm2d(256),
            nn.ReLU(True)
        )
        ...
        self.layer3 = nn.Sequential(
            nn.Conv2d(in_channels=256, out_channels=384, kernel_size=(6, 1), stride=(2, 1), padding=0),
            nn.BatchNorm2d(384),
            nn.ReLU(True),
            nn.Conv2d(in_channels=384, out_channels=384, kernel_size=(6, 1), stride=(2, 1), padding=0),
            nn.BatchNorm2d(384),
            nn.ReLU(True)
        )
