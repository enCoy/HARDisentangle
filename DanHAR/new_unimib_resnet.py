...
def test(epoch):
    ...
    with torch.no_grad():
        for batch_idx, (inputs, targets) in enumerate(testloader):
            ...
            # print(error_list)
            np.save('/home/gaowenbing/desktop/dd/Torch_Har_cbam/store_visual/unimib/epoch_new_resnet',epoch_list)
            np.save('/home/gaowenbing/desktop/dd/Torch_Har_cbam/store_visual/unimib/error_new_resnet',error_list)
