...
testloader = Data.DataLoader(dataset=testset, batch_size=3295, shuffle=False, num_workers=0)
...
#
#     plt.tight_layout()
#     plt.savefig('/home/gaowenbing/desktop/dd/Torch_Har_cbam/store_visual/confusion_matrix/wisdom_baseline/wisdom_baseline.png')
#     plt.show()
...
def test(epoch):
    ...
    with torch.no_grad():
        for batch_idx, (inputs, targets) in enumerate(testloader):
            ...
            # outputs_onehot=to_one_hot(outputs)
            # outputs_onehot=outputs_onehot.cuda()
        ...
        #     np.save('/home/gaowenbing/desktop/dd/Torch_Har_cbam/store_visual/wisdom/wisdom_epoch_b_2',epoch_list)
        #     # np.save('/home/gaowenbing/desktop/dd/Torch_Har_cbam/store_visual/opp_accuracy_b',accuracy_list)
