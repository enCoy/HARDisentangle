...
def test(epoch):
    ...
    with torch.no_grad():
        ...
        #                    ['Going downstairs', 'Jogging', 'Jumping', 'Going upstairs'])
            # np.save('/home/gaowenbing/desktop/dd/Torch_Har_cbam/store_visual/weaklylableddata/wld_epoch_b_SGDm',epoch_list)
            # np.save('/home/gaowenbing/desktop/dd/Torch_Har_cbam/store_visual/weaklylableddata/wld_error_b_SGDm',error_list)
