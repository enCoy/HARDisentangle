...
# torch.Size([25343, 1, 107, 64]) torch.Size([25343, 17])
# torch.Size([5313, 1, 107, 64]) torch.Size([5313, 17])
...
def test(epoch):
    ...
    with torch.no_grad():
        for batch_idx, (inputs, targets) in enumerate(testloader):
            ...
            # print(error_list)
            # np.save('/home/gaowenbing/desktop/dd/Torch_Har_cbam/store_visual/opp/epoch_opp_resnet_att_new_2.npy',epoch_list)
            # np.save('/home/gaowenbing/desktop/dd/Torch_Har_cbam/store_visual/opp/error_opp_resnet_att_new_2.npy',error_list)
